...
(function(){
    ...
    tinymce.create('tinymce.plugins.summarize_posts', {
        ...
        init : function(ed, url){
            ed.addButton('summarize_posts', {
                title : 'Insert summarize_posts',
				onclick : function() {
					// triggers the thickbox
					var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
					W = W - 80;
					H = H - 84;
					tb_show( 'Summarize Posts Shortcode', '#TB_inline?width=' + W + '&height=' + H + '&inlineId=summarize_posts_form' );
				},
	...
	jQuery(function(){
		...
		var form = jQuery('<div id="summarize_posts_form"><table id="summarize_posts-table" class="form-table">\
			<tr>\
